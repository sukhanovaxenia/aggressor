...
from aggressor.core.config import AGGREGATION_PROPENSITY
...
class HydrophobicAromaticCluster:
    ...
    nearby_hydrophobic_distances: Tuple[int, ...] = ()  # parallel to positions; validates vdW contact feasibility
            ...
            'nearby_hydrophobics': [
                {
                    ...
                    'distance': (
                        ...
                        if i < len(self.nearby_hydrophobic_distances) else 0
                    ),
                    'residue': (
                        self.residues[self.positions.index(p)]
                        if p in self.positions else '?'
                    ),
                }
                for i, p in enumerate(self.nearby_hydrophobic_positions)
            ],
        }
