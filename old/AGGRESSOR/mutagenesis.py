...
def _parse_region(region_str: str, seq_length: int) -> Tuple[int, int]:
    """
    Parse region string in format start:stop (1-indexed).

    This is an internal duplicate of CLI.parse_region to avoid
    circular imports. The CLI module also has its own copy.
